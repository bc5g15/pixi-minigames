...
/*
 * Puzzle 1 - Simple version with 4 buttons and lights
 */
...
const lightData = {
    0: {x:-POS, y:-POS, on:false, graph:null},
    1: {x:POS, y:-POS, on:false, graph:null},
    2: {x:POS, y:POS, on:false},
    3: {x:-POS, y:POS, on:false}
}
const light_r = 18;
...
*/
const buttonData = [
    {x: -4, y: -4, n: 0, on:false, graph:null},
    {x: 4, y: -4, n: 1, on:false},
    {x:-4, y:4, n:2, on:false},
    {x:4, y:4, n:3, on:false}
];
